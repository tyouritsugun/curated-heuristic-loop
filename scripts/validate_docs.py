...
def validate_architecture_doc(project_root: Path) -> bool:
    ...
    Returns True if valid, False otherwise.
    """
    print("\n📄 Validating doc/architecture.md...")

    arch_path = project_root / "doc" / "architecture.md"
    if not arch_path.exists():
        print("⚠️  doc/architecture.md not found (optional)")
        return True
    ...
    if all_errors:
        print("❌ doc/architecture.md validation failed:")
        for error in all_errors:
            print(error)
        return False

    print("✅ doc/architecture.md validation passed")
    return True
...
def validate_manual_doc(project_root: Path) -> bool:
    ...
    Returns True if valid, False otherwise.
    """
    print("\n📄 Validating doc/manual.md...")

    manual_path = project_root / "doc" / "manual.md"
    if not manual_path.exists():
        print("⚠️  doc/manual.md not found (optional)")
        return True
    ...
    if all_errors:
        print("❌ doc/manual.md validation failed:")
        for error in all_errors:
            print(error)
        return False

    print("✅ doc/manual.md validation passed")
    return True
...
def main() -> int:
    ...
    if all(results):
        ...
        print("  ✅ File references are valid")
        print("  ✅ Script names are correct")
        print("  ✅ Version numbers are consistent")
