...
from src.api.services.telemetry_names import QUEUE_DEPTH, WORKER_POOL
...
class TelemetryService:
    ...
    def _current_worker_metrics(self, session: Session):
        rows = (
            ...
            .order_by(WorkerMetric.heartbeat_at.desc())
            .all()
        )
        return [
            {
    ...
    def _recent_jobs(self, session: Session, limit: int = 5):
        rows = (
