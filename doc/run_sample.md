...
1. **Add your own categories**: Update the code-defined taxonomy for your team's workflows (architecture decisions, code review checklists, deployment procedures, etc.). See [Managing Categories in the Operator Guide](manual.md#62-managing-categories) for steps.
